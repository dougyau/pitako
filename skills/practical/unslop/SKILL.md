---
name: unslop
description: Cut AI tells from documentation, explanations, and PR text. Use when writing prose. Do not apply to code reasoning or debugging.
---

# Unslop

Use on documentation, explanations, and PR text. Do not let this skill steer coding or debugging.
