...
const PATTERNS: Array<{ reason: FallbackReason; pattern: RegExp }> = [
  ...
  { reason: "unavailable", pattern: /model .{0,40}not found|model .{0,40}unavailable|unknown model|no such model|provider unavailable|overloaded|service unavailable|internal server error|fetch failed|socket hang up|econnreset|econnrefused|connection reset|connection refused|network error|transport unavailable|request timed out|etimedout|\b500\b|\b502\b|\b503\b|\b504\b/i },
];
